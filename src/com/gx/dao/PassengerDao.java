...
public interface PassengerDao {
	   ...
	   //ajax 验证是否存在 此身份证号码
	   public int selectYZ(@Param("name")String name,@Param("number")String number);
	    ...
	    public PassengerPo selectNameAndNumber(@Param("name")String name,@Param("number")String number);
