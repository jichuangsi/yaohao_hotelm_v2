...
public interface OrderDao {
    ...
    public List<OrderDetailsVo> orderBySupplier(@Param("supplierID") Integer supplierID, @Param("start") int start, @Param("size") int size);
    public Integer countOrderBySupplier(@Param("supplierID") Integer supplierID);
}
