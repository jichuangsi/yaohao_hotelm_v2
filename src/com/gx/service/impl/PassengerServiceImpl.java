...
public class PassengerServiceImpl implements PassengerService {
	...
	@Override
	public int selectYZ(String name,String number) {
		return this.passengerDao.selectYZ(name,number);
	}

	@Override
	public PassengerPo selectNameAndNumber(String name, String number) {
		return passengerDao.selectNameAndNumber(name, number);
	}
}
