...
(function () {
    ...
    // getRootPath()+"/WebContent/js/utf8-jsp/"
    /**
    ...
    window.UEDITOR_CONFIG = {
		...
		,imagesUrl:getRootPath()+"/Order/uploadImg.do"
		,imageActionName:"uploadImage"
		,imageFieldName:"upload"
		,imageMaxSize:5442880
		,imageUrlPrefix:"" //../images/{filename}
        ,imagePathFormat:"../images/{filename}"
        ...
        // 服务器统一请求接口路径
        , serverUrl:getRootPath()+"/upload/enter.do"

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义 'fullscreen','superscript', 'subscript',
        , toolbars: [[
            'source', '|', 'undo', 'redo', '|',
