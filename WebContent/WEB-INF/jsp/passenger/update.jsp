...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">旅客修改  Passenger modification</h3>
    ...
    function verify() {
        if (document.getElementById("nameId").value == "") {
            ...
            return false;
                ...
                alert("你输入的   备注  太过长了  请不要超出  50 位长度"+"The note is too long,Please do not exceed the length of 50 digits");
