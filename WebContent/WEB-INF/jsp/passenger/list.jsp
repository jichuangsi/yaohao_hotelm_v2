...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" >
    <div class="span4">
	    <div class="row-fluid">
		    <label class="labelroomnumber">旅客名称：<br/><span style="font-size: 12px;">Name</span></label>
      ...
      <div class="row-fluid">
       ...
       <%--<div class="span3">
         <button class="btn btn-danger btn-small textone" type="button" onclick="deletefunction()">
             <li class="icon-remove icon-white"></li>删除</button>
       </div>--%>
      </div>
    </div>
	      ...
	      <thead class="theadone">
	        <tr>
	          ...
	          <th >联系电话<br/><span style="font-size: 12px;">Contact number</span></th>
				<th>注册时间<br/><span style="font-size: 12px;">Registration time</span></th>
	        </tr>
	      </thead>
	      <tbody id="tbody">
