...
<div class="x-body">
    ...
    <input type="hidden" value="${platformId}" id="platform">
    <%--<div class="layui-row">&lt;%&ndash;action="${ctx}/Hotelm/allorder.do"&ndash;%&gt;
        <form class="layui-form layui-col-md12">
            ...
            <div class="layui-input-inline">&lt;%&ndash;1未确认 2已确认 3 已撤销 4待入住 5已入住 6退房&ndash;%&gt;
    ...
    $(".tcdPageCode").createPage({
        ...
        backFn: function (p) {
           var platform = document.getElementById("platform").value;
            window.location='${ctx}/Order/orderByplatform.do?platformId='+platform+"&currentPage="+p;
    ...
    layui.use(['form', 'table', 'element', 'laydate'], function () {
        ...
        window.confirmOrder = function (value) {
            $.ajax({
                cache: false,                                             //是否使用缓存提交 如果为TRUE 会调用浏览器的缓存 而不会提交
                type: "POST",                                           //上面3行都是必须要的
                url: '${ctx}/Order/updateStatus2.do',       //地址 type 带参数
