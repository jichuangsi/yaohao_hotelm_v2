...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">商品新增(New products)</h3>
      </div>
    </div>
    ...
    <form action="${ctx}/Commodity/add.do" method="post" onsubmit="return verify()">
	    <div class="span12">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber">商品名称：<br/>Trade name</label>
			  ...
			  <div class="span5 ">
			   	  <label class="labelroomnumber">商品类别：<br/>Commodity category</label>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber">销售价格：<br/>Selling price</label>
			  ...
			  <div class="span5">
			   	  <label class="labelroomnumber">计量单位：<br/>Unit of measurement</label>
 ...
 <script type="text/javascript">
   ...
   if(document.getElementById("salePriceId").value!=""){
       ...
       if(!document.getElementById("salePriceId").value.trim().match("^[0-9]+(\\.[0-9]+)?$"))
       {
          ...
          alert("销售价格:请输入正数"+' \n '+"Sales price: Please enter a positive number");
       }
     }else{
       document.getElementById("divTwo").style.display="block"; //显示
     }
     ...
     if(value!=""){
       $.ajax({                                                      
          ...
          success: function (result) {                          // 不出现异常 进行立面方
              if(result>=1){                                  
                   alert("已存在此商品名称，请另取商品名称！"+' \n '+"This product name already exists, please take another product name");                     //提示框
