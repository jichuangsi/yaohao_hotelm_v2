			...
			<div class="layui-row">
				<form class="layui-form layui-col-md12">
					<div class="layui-input-inline">
						<input type="text" name="txtname" id="txtname" placeholder="酒店关键字" autocomplete="off" class="layui-input" style="width: 200px;">
					</div>
	...
	<script>
        ...
        $(".tcdPageCode").createPage({
            ...
            backFn:function(p){
                ...
                location.href="${ctx}/Supplier/tolist.do?currentPage="+p+"&txtname="+txtname;
            }
        });
		function add() {
			index = layer.open({
