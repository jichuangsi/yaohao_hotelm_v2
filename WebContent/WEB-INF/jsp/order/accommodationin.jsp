		...
		<c:forEach items="${list.result}" var="item">
			...
			<%--<div class="layui-col-md6 layui-col-xs12 layui-col-md6">
				<div class="rmb-box-ht">
					...
					<div class="rmb-title layui-row">
						<div class="layui-col-xs2 layui-col-xs-offset8"><span class="layui-btn layui-btn-normal layui-btn-sm">退房</span></div>
						&lt;%&ndash;<div class="layui-col-xs2 "><span class="layui-btn layui-btn-normal layui-btn-sm">撤销</span></div>&ndash;%&gt;
					</div>
				</div>
			</div>
		</div>
